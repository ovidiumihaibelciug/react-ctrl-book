        ...
        return (
            <div className="book-box">                
                ...
                <div className="right-side">
                    ...
                    <div className="title">{this.parseText(volumeInfo.title, 50)}</div>
                    <div className="author">by {this.parseText(authors, 50)}</div>
                    <div className="rating">
                        <Rating score={rating} /> {!rating ? ' No votes' : ''}
                    </div>
                    <div className="description">
                        {this.parseText(volumeInfo.description ? volumeInfo.description : '', 120)}
                    </div>
                </div>
                <div className="likes">
